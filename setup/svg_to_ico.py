...
# PromptPainter ships its brand mark as assets/logo.svg (there is no
# separate icon.svg); the ICO the build embeds into the exe is rendered
# from it into assets/icon.ico.
