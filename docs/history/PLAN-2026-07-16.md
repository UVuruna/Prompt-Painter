# PLAN — the Design Discussion (2026-07-16, historical)

**Archived 2026-08-18** (moved from the project root, `git mv`): every
decision this discussion produced is now binding fact in
[`../../CLAUDE.md`](../../CLAUDE.md) and [`../DECISIONS.md`](../DECISIONS.md).
Kept for the reasoning and alternatives behind those decisions — read the
current spec first.
